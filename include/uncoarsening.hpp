...
namespace Uncoarser {
    ...
    // returns: partition of the original graph                        | {Part::First, Part::Second, Part::First, Part::Second}
	...
	// returns: partition of the finer graph obtained by direct mapping            | {Part::First, Part::First, Part::Second, Part::Second}
	...
	// returns: refined partition of the finer graph using Kernighan-Lin algorithm | {Part::First, Part::Second, Part::First, Part::Second}
